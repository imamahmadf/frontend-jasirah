...
const menuData = [
  {
    title: "Mitra",
    icon: GoShieldLock,
    pathPrefix: "/mitra-kpbpn",
    items: [{ label: "Daftar Mitra", path: "/mitra-kpbpn/daftar" }],
  },
    ...
    return (
      <Link to={item.path} onClick={onItemClick}>
        <Box
          ...
          overflow="hidden"
          _hover={{
            bg: isActive ? "rgb(235, 153, 1)" : "gray.50",
            transform: "translateX(6px)",
            boxShadow: isActive
              ? "0 4px 12px rgb(235, 153, 1)"
      ...
      >
        <PopoverTrigger>
          <Button
            ...
            borderColor={isActive ? "kpbpn" : "transparent"}
            borderRadius="0"
            onClick={handleClick}
        ...
        <PopoverContent
          ...
          _before={{
            ...
            right: 0,
            height: "3px",
            bgGradient: "linear(to-r, kpbpn, rgb(235, 153, 1))",
          }}
        >
          <PopoverArrow
            bg="white"
                  ...
                  <Menu>
                    ...
                    <MenuList
                      ...
                      _before={{
                        ...
                        right: 0,
                        height: "3px",
                        bgGradient: "linear(to-r, aset, rgb(235, 153, 1))",
                      }}
                    >
                      <Link to={"/profile"}>
                        <MenuItem
                  ...
                  return (
                    ...
                    >
                      <AccordionButton
                        px={4}
                        py={3.5}
                        bg={isActive ? "kpbpn" : boxBg}
                        color={isActive ? "white" : textColor}
                        fontWeight="600"
                        _hover={{
                          bg: isActive ? "rgb(235, 153, 1)" : hoverBg,
                        }}
                        borderLeft={
                          isActive ? "4px solid" : "4px solid transparent"
                        }
                        borderColor={
                          isActive ? "rgb(235, 153, 1)" : "transparent"
                        }
                        transition="all 0.2s ease"
                      >
                            ...
                            return (
                              ...
                              >
                                <Box
                                  px={6}
                                  py={2.5}
                                  bg={itemIsActive ? "kpbpn" : "transparent"}
