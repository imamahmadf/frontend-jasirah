// src/pages/PerjalananKadis/hooks/usePerjalananKadisData.js
import { useState, useEffect } from "react";
import axios from "axios";
import { useToast } from "@chakra-ui/react";
import { useHistory } from "react-router-dom";

const usePerjalananKadisData = (user) => {
    ...
    axios
      .post(
        ...
        }/perjalanan/post/nota-dinas`,
        {
          ...
          dasar: values.dasar,
          asal: values.asal,
          kodeRekeningFE: `${dataSubKegiatan?.value?.kodeRekening}${
            jenisPerjalanan?.value?.kodeRekening || ""
          }`,
      ...
      .then((res) => {
        ...
        if (isNotaDinas === 2) {
          ...
          setTimeout(() => history.push("/daftar/kadis"), 1000);
        }
      })
      .catch((err) => {
        console.error(err);
...
export default usePerjalananKadisData;
